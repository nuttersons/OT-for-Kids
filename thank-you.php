...
<div class="main-content">
	<div id="bread_crumbs">You are here  &raquo;
					<a class="active" href="/website69b/thank-you.php">Thank You</a> &raquo;
		</div>
			  <h1>Thank you!</h1>
			  <br />
              
				<br />
				<p>We have received your form, a member of our team will contact you shortly.</p>
<br />
				<p>Best Regards</p> 
<br /><br />


				<a href="/website69b/index.php">Return to Home</a>	
