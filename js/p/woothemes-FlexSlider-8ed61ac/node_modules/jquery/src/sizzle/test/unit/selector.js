...
/*
	...
	url( "some/url.php" );
		...
		@example url("data/test.php") => "data/test.php?10538358428943"
...
test("element", function() {
	...
	iframeDoc.open();
	iframeDoc.write("<body><p id='foo'>bar</p><script>
...
test("id", function() {
	...
	t( "ID selector using UTF8", "#??Táibei", ["??Táibei"] );
	t( "Multiple ID selectors using UTF8", "#??Táibei, #??", ["??Táibei","??"] );
...
test("class", function() {
	...
	t( "Class selector using UTF8", ".??Táibei", ["utf8class1"] );
	//t( "Class selector using UTF8", ".??", ["utf8class1","utf8class2"] );
	t( "Class selector using UTF8", ".??Táibei.??", ["utf8class1"] );
	t( "Class selector using UTF8", ".??Táibei, .??", ["utf8class1","utf8class2"] );
	t( "Descendant class selector using UTF8", "div .??Táibei", ["utf8class1"] );
	t( "Child class selector using UTF8", "form > .??Táibei", ["utf8class1"] );
...
test("pseudo - misc", function() {
	...
	// http://dev.w3.org/html5/spec/single-page.php#focus-management
	document.body.appendChild( tmp );
	tmp.tabIndex = 0;
	tmp.focus();
...
asyncTest( "Iframe dispatch should not affect Sizzle, see jQuery #13936", 1, function() {
	...
	iframeDoc.open();
	iframeDoc.write("<body><form id='navigate'></form><script>
  (function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
  (i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),
  m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)
  })(window,document,'script','//www.google-analytics.com/analytics.js','ga');
