...
<HEAD>
<TITLE>Error | OT for Kids - Children's Occupational Therapy Services</TITLE>
...
<div class="main-content">
	<div id="bread_crumbs">You are here  &raquo;
					<a class="active" href="/website69b/error.php">Error</a> &raquo;
		</div>
			  <h1>Oops!</h1>
			  <br />
              <h2>There has been an error with your form. </h2>
              
				<br />
				<p>Please make sure all the boxes marked with a * are completed. </p>
<br />
...
<p>Please press the <b>'back button'</b> on your browser and ensure all boxes within the form are completed correctly. 
</p>	
